...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-30 flex h-screen flex-col bg-[#1A3C5E] text-white shadow-xl transition-all duration-300 ${
          collapsed ? "w-20 px-2 lg:w-20" : "w-64 px-3 lg:w-64"
      ...
      >
        ...
        <div className="flex flex-col gap-3 py-4">
          <button
            type="button"
            onClick={onCloseMobile}
            className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-xs font-medium text-white transition hover:bg-white/10 lg:hidden"
          >
            Close Menu
          </button>
